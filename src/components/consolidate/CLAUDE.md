...
| `MergeReviewStep` | "Merge your <token> notes", notes `N → M`, the summary, an explainer, whether the blocked action goes through afterwards, blocked-confirm notice, Cancel / Confirm merge. |
